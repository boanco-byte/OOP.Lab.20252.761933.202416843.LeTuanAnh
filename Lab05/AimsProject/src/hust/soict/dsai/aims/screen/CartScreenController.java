...
public class CartScreenController {
    ...
    @FXML private TableColumn<Media, String> colMediaCost;
    ...
    private void initialize() {
        ...
        colMediaCost.setCellValueFactory(cellData -> new SimpleStringProperty(String.format("%.2f", cellData.getValue().getCost())));
